...
- запрос в котором указан неподдерживаемый тип метода или вовсе отсутствует указание на тип метода вернёт ошибку [405 Method Not Allowed](errors.md#код-405-статус-method-not-allowed)
- запрос который не проходит валидацию вернёт ошибку [415 Unsupported Media Type](errors.md#код-415-статус-unsupported-media-type).
